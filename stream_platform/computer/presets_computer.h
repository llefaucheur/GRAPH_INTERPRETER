...
#ifndef cPRESET_COMPUTER_H
#define cPRESET_COMPUTER_H
...
#undef CODE_ARM_ANR                  /* SDS audio noise reduction */
#undef CODE_ARM_ECHOCAN              /* SDS audio echocanceller */
#undef CODE_ARM_FIXEDBF              /* SDS audio fixed direction beamformer */
#undef CODE_ARM_KWS                  /* SDS keyword spotting */
...
//
// SERV_GROUP_STDLIB                    /* 2  Compute : malloc, string */
...
//------------------------------------------------------------------------------------
#ifdef PLATFORM_SDS_DEMO
#include "platform_sds_demo.h"
#endif
