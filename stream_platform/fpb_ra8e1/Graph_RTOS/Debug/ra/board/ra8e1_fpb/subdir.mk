...
C_SRCS += \
../ra/board/ra8e1_fpb/board_init.c \
../ra/board/ra8e1_fpb/board_leds.c 

C_DEPS += \
./ra/board/ra8e1_fpb/board_init.d \
./ra/board/ra8e1_fpb/board_leds.d 

CREF += \
Graph_RTOS.cref 

OBJS += \
./ra/board/ra8e1_fpb/board_init.o \
./ra/board/ra8e1_fpb/board_leds.o 
...
ra/board/ra8e1_fpb/%.o: ../ra/board/ra8e1_fpb/%.c
	@echo 'Building file: $<'
