...
#include "../../Include/dsp/default_filtering_functions.h"
...
/**
  ...
  <pre>
      arm_biquad_cascade_df1_inst_f32 S1 = {numStages, pState, pCoeffs};
      arm_biquad_cascade_df1_inst_q15 S2 = {numStages, pState, pCoeffs, postShift};
      arm_biquad_cascade_df1_inst_q31 S3 = {numStages, pState, pCoeffs, postShift};
  </pre>
