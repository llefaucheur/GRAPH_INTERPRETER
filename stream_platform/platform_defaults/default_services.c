...
/**
  ...
  @remark
 */
static void arm_stream_services_internal(uint32_t command, intptr_t ptr1, intptr_t ptr2, intptr_t ptr3, intptr_t n) 
{
...
/**
  ...
  @remark
 */
static void arm_stream_services_script (uint32_t command, intptr_t ptr1, intptr_t ptr2, intptr_t ptr3, intptr_t n) 
{
...
/**
  ...
  @remark
 */
static void arm_stream_services_conversion (uint32_t command, intptr_t ptr1, intptr_t ptr2, intptr_t ptr3, intptr_t n) 
{
...
void arm_stream_services_stdlib (uint32_t command, intptr_t ptr1, intptr_t ptr2, intptr_t ptr3, intptr_t n) 
{
#ifdef SERV_STDLIB
	switch (RD(command, FUNCTION_SSRV))
    {
...
/**
  ...
  @remark
 */
void arm_stream_services_math (uint32_t command, intptr_t ptr1, intptr_t ptr2, intptr_t ptr3, intptr_t n) 
{
    /* 
...
/**
  ...
  @remark
 */
void arm_stream_services_mm_audio (uint32_t command, intptr_t ptr1, intptr_t ptr2, intptr_t ptr3, intptr_t n) 
{
#ifdef SERV_EXTAUDIO
...
/**
  ...
  @remark
 */
void arm_stream_services_mm_image (uint32_t command, intptr_t ptr1, intptr_t ptr2, intptr_t ptr3, intptr_t n) 
{
#ifdef SERV_EXTIMAGE
 ...
 */
void arm_stream_command_interpreter (uint32_t command, intptr_t ptr1, intptr_t ptr2, intptr_t ptr3, intptr_t n) 
{
}
...
void arm_stream_services (uint32_t command, intptr_t ptr1, intptr_t ptr2, intptr_t ptr3, intptr_t n) 
{   
    ...
    case SERV_GROUP_DSP_ML:
            ...
            */
            ...
            case SERV_DSP_CASCADE_DF1_Q15:          /* IIR filters arm_biquad_cascade_df1_fast_q15*/
                #ifdef PLATFORM_SERV_CASCADE_DF1_Q15
                    ...
                    {   
                        ...
                        platform_biquad_cascade_df1_init_q15((biquad_cascade_df1_inst_q15 *)ptr1, (uint8_t)(n >> 8), (uint16_t *)ptr2, (int16_t *)ptr3, (int8_t)n);
                    ...
                    {   
                        ...
                        //        int16_t * pDst,
                        //        uint32_t blockSize );
                        platform_biquad_cascade_df1_q15((biquad_cascade_df1_inst_q15 *)ptr1, (int16_t *)ptr2, (int16_t *)ptr3, (uint32_t)n);
                    }
                #else
                    if (RD(command,  COMMAND_SSRV) == SERV_INIT)
                    {   default_biquad_cascade_df1_init_q15(                   // void arm_biquad_cascade_df1_init_q15(
                            (arm_biquad_cascade_df1_inst_q15 *) ptr1,         //         biquad_cascade_df1_inst_q15 * S,
                    ...
                    {   default_biquad_cascade_df1_fast_q15(                    // void stream_filter_arm_biquad_cascade_df1_fast_q15(
                            (const arm_biquad_cascade_df1_inst_q15 *) ptr3,    //   const arm_biquad_cascade_df1_inst_q15 * S,
            ...
            case SERV_DSP_CASCADE_DF1_F32:          /* IIR filters arm_biquad_cascade_df1_f32*/
              #ifdef PLATFORM_SERV_CASCADE_DF1_F32
                    if (RD(command,  COMMAND_SSRV) == SERV_DSP_INIT)
                ...
                #else
                    if (RD(command,  COMMAND_SSRV) == SERV_DSP_INIT)
                    {   extern df1_init_f32 default_biquad_cascade_df1_init_f32;
                        default_biquad_cascade_df1_init_f32(                 // void arm_biquad_cascade_df1_init_f32(
                            (biquad_cascade_df1_inst_f32 *) ptr1,                   //         biquad_cascade_df1_inst_q15 * S,
                            n & 0xFF,                                               //         uint8_t numStages,
                            (const float *) ptr2,                                   //   const q15_t * pCoeffs,
                            (float *) ptr3);                                        //         q15_t * pState)

                    } else //(RD(command,  COMMAND_SSRV) == SERV_DSP_RUN)
                    {   extern df1_f32 default_biquad_cascade_df1_f32;
                        default_biquad_cascade_df1_f32(                     // void arm_biquad_cascade_df1_fast_f32(
                            (const biquad_cascade_df1_inst_f32 *) ptr3,             //   const arm_biquad_cascade_df1_inst_f32 * S,
