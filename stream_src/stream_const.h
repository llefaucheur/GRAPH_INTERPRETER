...
/* 
  ...
  *- SCRIPTS are adressed with a table_int32[128] : offset, ARC, binary format
        ...
        The first NODE of the graph is a SWC-script interpreting the use-case command, in cascade
          this script will call other subgraph's script and NODE with SET_PARAM. The graph compilation 
          tool generates the table of index to let NODE be found with name mangling in the graph hierarchy
...
#define   NEW_USE_CASE_SCRIPT_MSB U(28) /*  1  new use-case arrived */ 
#define   NEW_USE_CASE_SCRIPT_LSB U(28) /*     */ 
...
#define  LOADFMT_LW0_LSB U(23) /*   controled by "node_using_arc_format" in the graph */
...
/*==========================================  ARCS  ===================================================*/
                ...
                //#define PRODUCFMT_ARCW0_LSB U(27) /*    Graph generator gives IN/OUT arc's frame size to be the LCM of NODE "grains" */
                ...
                //#define    RDFLOW_ARCW2    U( 2)  /* write access only from the NODE consumer */
                ...
                //#define FLOWERROR_ARCW2_LSB U(26) /* 1  under/overflow 0=nothing or best effort from IO_DOMAIN_IOFMT0 */
                //#define    _______ARCW2_MSB U(25) /*    */
                //#define    _______ARCW2_LSB U(22) /* 4  */
                ...
                //#define  WRIOCOLL_ARCW3    U( 3) /* write access only from the NODE producer */
...
#define    _______ARCW2_MSB U(31) 
#define    _______ARCW2_LSB U(27) /* 5  */
#define ARCEXTEND_ARCW2_MSB U(26) /*    Size/Read/Write are used with <<(2x{0..7}) to extend base/size/read/write arc */
#define ARCEXTEND_ARCW2_LSB U(24) /* 3  to  256MB, 4GB, 64GB , for use-cases with NN models, video players, etc */
...
#define __________ARCW4_MSB U(31) 
#define __________ARCW4_LSB U(31) /*  1 */ 
...
#define CONSUMFMT_ARCW4_LSB U( 8) /*  8 CONSUMER format  */ 
