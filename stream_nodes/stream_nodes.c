...
6.	stream_dsp_filter
    ...
    is Q5-DF1 with error spectral shaping
    ...
    Presets : Bandwidth + Fc + (LPF, HPF, BPF), and a DC offset canceller
...
8.	stream_codec, stream_decompression
...
10.	signal generator
    Operation : sine, noise, sweep, square, modulated bit-stream (FSK, AM, QAM)
...
extern p_stream_node arm_stream_serial_data;
...
p_stream_node node_entry_point_table[NB_NODE_ENTRY_POINTS] =
{
    ...
    /*  0*/ (void *)0,
    /*  1*/ (void *)&arm_script, 
    /*  2*/ (void *)&arm_stream_route,                       
    /*  3*/ (void *)&arm_stream_converter,                      
    /*  4*/ (void *)&arm_stream_amplitude,                
    /*  5*/ (void *)&arm_stream_mixer,                         
    /*  6*/ (void *)&arm_stream_dsp_filter,                             
    /*  7*/ (void *)&arm_stream_detector,                         
    /*  8*/ (void *)&arm_stream_codec,                    
    /*  9*/ (void *)&arm_stream_data_conditioning,           
    /* 10*/ (void *)&arm_stream_generator,        
    /* 11*/ (void *)&arm_stream_serial_data,
    /* 12*/ (void *)&arm_stream_frequency_estimator,
    /* 13*/ TBD,
    /* 14*/ TBD, 
    /* 15*/ TBD,
