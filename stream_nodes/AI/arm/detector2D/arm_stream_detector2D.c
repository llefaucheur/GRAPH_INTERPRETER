...
#include "arm_stream_detector2D.h"


/*
;----------------------------------------------------------------------------------------
;7.	arm_stream_detector2D
;----------------------------------------------------------------------------------------
 ...
 */
void arm_stream_detector2D (int32_t command, stream_handle_t instance, stream_xdmbuffer_t *data, uint32_t *status)
{
    ...
    { 
        ...
        */
        ...
        {   stream_al_services *stream_entry = (stream_al_services *)data;
            ...
            arm_detector2D_instance *pinstance = (arm_detector2D_instance *) *memresults;

            /* here reset */
            pt8bdst = (uint8_t *) pinstance;
            n = sizeof(arm_detector2D_instance);
            for (i = 0; i < n; i++)
            {   pt8bdst[i] = 0;
            }
