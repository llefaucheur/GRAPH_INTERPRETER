 ...
 * Title:        arm_stream_interpolator2D.c
 * Description:  filters
 *
...
#include "arm_stream_interpolator2D.h"

/*-------------------------------------
    data format conversion
---------------------------------------
*/
extern void arm_stream_interpolator2D_process (arm_stream_interpolator2D_instance *instance, uint8_t TAG_CMD, stream_xdmbuffer_t *in_out);

/*
;----------------------------------------------------------------------------------------
;Node #3.	arm_stream_interpolator2D
;----------------------------------------------------------------------------------------
...
;
    arm_stream_interpolator2D; 0 instance; 0 raw conversion; 0 no parameter; 
*/
 ...
 */
void arm_stream_interpolator2D (int32_t command, stream_handle_t instance, stream_xdmbuffer_t *data, uint32_t *status)
{
    ...
    { 
        ...
        */
        ...
        {   stream_al_services *stream_entry = (stream_al_services *)(uint64_t)data;
            ...
            arm_stream_interpolator2D_instance *pinstance = (arm_stream_interpolator2D_instance *) *memresults;
            break;
        }    
        ...
        */ 
        ...
        {  // uint16_t *pt8bsrc, *pt8bdst, i, n;
            ...
            arm_stream_interpolator2D_instance *pinstance = (arm_stream_interpolator2D_instance *) instance;

            /* copy the parameters from preset or from the graph */
            if (RD(command, PRESET_CMD) == 0)
            { 
            //arm_stream_interpolator2D_process ()
            }
            break;
        }
