 ...
 * Title:        arm_stream_format_converter_process.c
 * Description:  filters
 *
...
#include "platform.h"
#ifdef CODE_ARM_STREAM_CONVERTER
...
/**
  ...
  @return        none
 */
int32_t arm_stream_format_converter_calls_stream (int32_t command, arm_stream_format_converter_instance *instance, stream_xdmbuffer_t *data, uint32_t *status)
{
    stream_al_services *stream_services; /* function pointer used for debug/trace, memory move and free, signal processing */
...
*/
void arm_stream_format_converter_process (arm_stream_format_converter_format *in, arm_stream_format_converter_format *out, stream_xdmbuffer_t *in_out)
{
...
#endif  // #ifdef CODE_ARM_STREAM_CONVERTER
