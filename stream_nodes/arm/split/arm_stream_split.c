...
/*
    ...
    Operation : deinterleave a multichannel input arc to several output arcs (mono). 
            Split manages up to 8 output arcs. The parameter is a bit-field used to 
            select the channels to extract to an output arc. For example, stream_split 
            is extracting the channel #0 and #4 from an input stream having 6 
            channels : the bit-field selection will be (1<<0) + (1<<4) = 0x11. 
            The extracted channel #0 will go to the first output arc, and the 
            channel #4 to the second. 

    Parameters : bit-field selection (other stream details are shared during the reset sequence) 
*/
typedef struct
{   
...
/**
  ...
  @return        none
 */
void arm_stream_split_run(arm_stream_split_instance *instance, 
                     float *in,   
                     int32_t nb_samples, 
                     float *outBufs)
{
...
/**
  ...
  @return        none
 */
int32_t arm_stream_split (int32_t command, void *instance, void *data, void *parameters)
{
    ...
    { 
        ...
        */
        ...
        {   
            ...
            arm_stream_split_instance *pinstance = (arm_stream_split_instance *)*memreq++;
        ...
        */ 
        ...
        {   
            ...
            float *pCoeffs;
            float *pState;
            arm_stream_split_instance *pinstance = (arm_stream_split_instance *) instance;
        ...
        */     
        case STREAM_RUN:   
        {
            ...
            arm_stream_split_run(instance, (float *)inBuf,  
                                      nb_samples, 
                                      outBufs
                                      );
