...
/**
  ...
  @return        none
 */
int32_t arm_split_calls_stream (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    stream_entrance *STREAM; /* function pointer used for debug/trace, memory move and free, signal processing */
    arm_split_instance *pinstance = (arm_split_instance *)instance;
...
/**
  ...
  @return        none
 */
void split_processing (arm_split_instance *instance, 
 ...
 */
void arm_stream_split (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
