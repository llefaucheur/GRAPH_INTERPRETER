...
/**
  ...
  @return        none
 */
int32_t arm_route_calls_stream (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    stream_entrance *STREAM; /* function pointer used for debug/trace, memory move and free, signal processing */
    arm_route_instance *pinstance = (arm_route_instance *)instance;
...
/**
  ...
  @return        none
 */
void route_processing (arm_route_instance *instance, 
 ...
 */
void arm_stream_route (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
