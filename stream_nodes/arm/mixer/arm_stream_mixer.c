...
/**
  ...
  @return        none
 */
void arm_stream_mixer_run(arm_stream_mixer_instance *instance, 
                     float *in,   
                     int32_t nb_samples, 
                     float *outBufs)
{
...
/**
  ...
  @return        none
 */
int32_t arm_stream_mixer (int32_t command, void *instance, void *data, void *parameters)
{
    ...
    { 
        ...
        */
        ...
        {   
            ...
            arm_stream_mixer_instance *pinstance = (arm_stream_mixer_instance *)*memreq++;
        ...
        */ 
        ...
        {   
            ...
            float *pCoeffs;
            float *pState;
            arm_stream_mixer_instance *pinstance = (arm_stream_mixer_instance *) instance;
        ...
        */     
        case STREAM_RUN:   
        {
            ...
            arm_stream_mixer_run(instance, (float *)inBuf,  
                                      nb_samples, 
                                      outBufs
                                      );
