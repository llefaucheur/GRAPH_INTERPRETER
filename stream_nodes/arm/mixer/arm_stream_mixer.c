...
/**
  ...
  @return        none
 */
int32_t arm_mixer_calls_stream (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
...
/**
  ...
  @return        none
 */
void mixer_processing (arm_mixer_instance *instance, 
 ...
 */
void arm_stream_mixer (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
