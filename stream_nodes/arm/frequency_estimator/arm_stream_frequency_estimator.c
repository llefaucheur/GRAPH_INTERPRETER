 ...
 * Title:        arm_frequency_estimator.c
 * Description:  filters
 *
...
typedef struct
{
    ...
    float data1;
    float data2;
} arm_frequency_estimator_instance;
...
/**
  ...
  @return        none
 */
int32_t arm_frequency_estimator_calls_stream (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    stream_entrance *STREAM; /* function pointer used for debug/trace, memory move and free, signal processing */
    arm_frequency_estimator_instance *pinstance = (arm_frequency_estimator_instance *)instance;
...
/**
  ...
  @return        none
 */
void frequency_estimator_processing (arm_frequency_estimator_instance *instance, 
 ...
 */
void arm_stream_frequency_estimator (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    ...
    { 
        ...
        */
        ...
        {   stream_entrance *stream_entry = (stream_entrance *)(uint64_t)data;
            ...
            arm_frequency_estimator_instance *pinstance = (arm_frequency_estimator_instance *) *memresults;
            memresults++;
            /* here reset */
