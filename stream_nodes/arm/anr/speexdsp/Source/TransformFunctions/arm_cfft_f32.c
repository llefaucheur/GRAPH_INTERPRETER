...
void arm_cfft_radix8by2_f32 (arm_cfft_instance_f32 * S, float32_t * p1)
{
  ...
  /* first col */
  arm_radix8_butterfly_f32 (pCol1, (uint16_t)L, (float32_t *) S->pTwiddle, 2U);

  /* second col */
  arm_radix8_butterfly_f32 (pCol2, (uint16_t)L, (float32_t *) S->pTwiddle, 2U);
}
...
void arm_cfft_radix8by4_f32 (arm_cfft_instance_f32 * S, float32_t * p1)
{
    ...
    *p4++ = m2 - m3;
    ...
    /* first col */
    arm_radix8_butterfly_f32 (pCol1, (uint16_t)L, (float32_t *) S->pTwiddle, 4U);

    /* second col */
    arm_radix8_butterfly_f32 (pCol2, (uint16_t)L, (float32_t *) S->pTwiddle, 4U);

    /* third col */
    arm_radix8_butterfly_f32 (pCol3, (uint16_t)L, (float32_t *) S->pTwiddle, 4U);

    /* fourth col */
    arm_radix8_butterfly_f32 (pCol4, (uint16_t)L, (float32_t *) S->pTwiddle, 4U);
}
        ...
        uint8_t bitReverseFlag)
{
  ...
  case 512:
  case 4096:
    arm_radix8_butterfly_f32 ( p1, (uint16_t)L, (float32_t *) S->pTwiddle, 1);
    break;
  }
