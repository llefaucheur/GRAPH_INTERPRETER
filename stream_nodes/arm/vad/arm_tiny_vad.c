...
/**
  ...
  @return        none
 */
void arm_tiny_vad_run(arm_tiny_vad_instance *instance, 
                     float *in,   
                     int32_t nb_samples, 
                     float *outBufs)
{
...
/**
  ...
  @return        none
 */
int32_t arm_tiny_vad (int32_t command, void *instance, void *data, void *parameters)
{
    ...
    { 
        ...
        */
        ...
        {   
            ...
            arm_tiny_vad_instance *pinstance = (arm_tiny_vad_instance *)*memreq++;
        ...
        */ 
        ...
        {   
            ...
            float *pCoeffs;
            float *pState;
            arm_tiny_vad_instance *pinstance = (arm_tiny_vad_instance *) instance;
        ...
        */     
        case STREAM_RUN:   
        {
            ...
            arm_tiny_vad_run(instance, (float *)inBuf,  
                                      nb_samples, 
                                      outBufs
                                      );
