...
/**
  ...
  @return        none
 */
int32_t arm_merge_calls_stream (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    stream_entrance *STREAM; /* function pointer used for debug/trace, memory move and free, signal processing */
    arm_merge_instance *pinstance = (arm_merge_instance *)instance;
...
/**
  ...
  @return        none
 */
void merge_processing (arm_merge_instance *instance, 
 ...
 */
void arm_stream_merge (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    ...
    { 
        ...
        */
        ...
        {   stream_entrance *stream_entry = (stream_entrance *)(uint64_t)data;
            ...
            arm_merge_instance *pinstance = (arm_merge_instance *) *memresults;
            memresults++;
            /* here reset */
