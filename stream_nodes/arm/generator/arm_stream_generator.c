...
/**
  ...
  @return        none
 */
int32_t arm_generator_calls_stream (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    stream_entrance *STREAM; /* function pointer used for debug/trace, memory move and free, signal processing */
    arm_generator_instance *pinstance = (arm_generator_instance *)instance;
...
/**
  ...
  @return        none
 */
void generator_processing (arm_generator_instance *instance, 
 ...
 */
void arm_stream_generator (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
