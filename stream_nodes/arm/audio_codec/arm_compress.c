 ...
 * Title:        arm_stream_compression.c
 * Description:  filters
 *
...
typedef struct
{
    ...
    float data1;
    float data2;
} arm_stream_compression_instance;
...
/**
  ...
  @return        none
 */
int32_t arm_stream_compression_calls_stream (int32_t command, void *instance, void *data, void *parameters)
{
    stream_entrance *STREAM; /* function pointer used for debug/trace, memory move and free, signal processing */
    arm_stream_compression_instance *pinstance = (arm_stream_compression_instance *)instance;
...
/**
  ...
  @return        none
 */
void arm_stream_compression_run(arm_stream_compression_instance *instance, 
 ...
 */
void arm_stream_compression (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    ...
    { 
        ...
        */
        ...
        {   stream_entrance *stream_entry = (stream_entrance *)(uint64_t)data;
            ...
            arm_stream_compression_instance *pinstance = (arm_stream_compression_instance *) memresults++;
        ...
        */              
        case STREAM_RUN:   
        {
            ...
            arm_stream_compression_run(instance, 
