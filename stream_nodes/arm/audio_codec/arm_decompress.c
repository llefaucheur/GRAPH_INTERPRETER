 ...
 * Title:        arm_stream_decompression.c
 * Description:  filters
 *
...
typedef struct
{
    ...
    float data1;
    float data2;
} arm_stream_decompression_instance;
...
/**
  ...
  @return        none
 */
int32_t arm_stream_decompression_calls_stream (int32_t command, void *instance, void *data, void *parameters)
{
    stream_entrance *STREAM; /* function pointer used for debug/trace, memory move and free, signal processing */
    arm_stream_decompression_instance *pinstance = (arm_stream_decompression_instance *)instance;
...
/**
  ...
  @return        none
 */
void arm_stream_decompression_run(arm_stream_decompression_instance *instance, 
...
/**
  ...
  @return        none
 */
int32_t arm_stream_decompression (int32_t command, void *instance, void *data, void *parameters)
{
    ...
    { 
        ...
        */
        ...
        {   stream_entrance *stream_entry = (stream_entrance *)(uint64_t)data;
            ...
            arm_stream_decompression_instance *pinstance = (arm_stream_decompression_instance *) memresults++;
            /* here reset */
        ...
        */         
        case STREAM_RUN:   
        {
            ...
            arm_stream_decompression_run(instance, 
