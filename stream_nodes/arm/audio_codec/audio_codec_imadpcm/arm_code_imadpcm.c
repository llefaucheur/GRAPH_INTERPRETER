...
/**
  ...
  @return        none
 */
int32_t arm_imadpcm_calls_stream (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
...
/**
  ...
  @return        none
 */
void imadpcm_processing (arm_imadpcm_instance *instance, 
