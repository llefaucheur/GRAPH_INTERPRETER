...
/**
  ...
  @return        none
 */
int32_t arm_serial_data_calls_stream (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    stream_entrance *STREAM; /* function pointer used for debug/trace, memory move and free, signal processing */
    arm_serial_data_instance *pinstance = (arm_serial_data_instance *)instance;
...
/**
  ...
  @return        none
 */
void serial_data_processing (arm_serial_data_instance *instance, 
 ...
 */
void arm_stream_serial_data (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    ...
    { 
        ...
        */
        ...
        {   stream_entrance *stream_entry = (stream_entrance *)(uint64_t)data;
            ...
            arm_serial_data_instance *pinstance = (arm_serial_data_instance *) *memresults;
            memresults++;
            /* here reset */
