...
/**
  ...
  @return        none
 */
int32_t arm_rate_converter_calls_stream (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
    stream_entrance *STREAM; /* function pointer used for debug/trace, memory move and free, signal processing */
    arm_rate_converter_instance *pinstance = (arm_rate_converter_instance *)instance;
...
/**
  ...
  @return        none
 */
void converter_processing (arm_rate_converter_instance *instance, 
 ...
 */
void arm_stream_rate_converter (int32_t command, uint32_t *instance, data_buffer_t *data, uint32_t *status)
{
