 ...
 * Title:        arm_stream_rate_converter.c
 * Description:  filters
 *
...
{   
    ...
    float state[2];
    float coef[5];
} arm_stream_rate_converter_instance;
...
/**
  ...
  @return        none
 */
void arm_stream_rate_converter_run(arm_stream_rate_converter_instance *instance, 
                     float *in,   
                     int32_t nb_samples, 
                     float *outBufs)
{
...
/**
  ...
  @return        none
 */
int32_t arm_stream_rate_converter (int32_t command, void *instance, void *data, void *parameters)
{
    ...
    { 
        ...
        */
        ...
        {   
            ...
            arm_stream_rate_converter_instance *pinstance = (arm_stream_rate_converter_instance *)*memreq++;
        ...
        */ 
        ...
        {   
            ...
            float *pCoeffs;
            float *pState;
            arm_stream_rate_converter_instance *pinstance = (arm_stream_rate_converter_instance *) instance;
        ...
        */     
        case STREAM_RUN:   
        {
            ...
            arm_stream_rate_converter_run(instance, (float *)inBuf,  
                                      nb_samples, 
                                      outBufs
                                      );
