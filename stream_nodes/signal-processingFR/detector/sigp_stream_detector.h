...
#ifndef csigp_STREAM_DETECTOR_H
...
extern void sigp_stream_detector_process (sigp_detector_instance *instance, 
                     int16_t *in, int32_t inputLength, 
                     int16_t *pResult);

#endif //csigp_STREAM_DETECTOR_H
