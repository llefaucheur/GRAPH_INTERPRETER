...
extern void arm_stream_converter_process1 (arm_stream_converter_format *in, arm_stream_converter_format *out, 
    float *inBuf, float *tmpBuf1);

extern void arm_stream_converter_process2 (fwd_ssrc_instance *ssrc,
    arm_stream_converter_format *input_format, arm_stream_converter_format *output_format, 
    float *inputBuffer, float *outputBuffer, int32_t nSampIn, intPtr_t  *nSampOut);

extern void arm_stream_converter_process3 (arm_stream_converter_format *out, 
