...
*/
void arm_stream_converter_process1 (arm_stream_converter_format *input, arm_stream_converter_format *output, 
...
*/
void arm_stream_converter_process2 (fwd_ssrc_instance *ssrc,
...
*/
void arm_stream_converter_process3 (arm_stream_converter_format *output, 
