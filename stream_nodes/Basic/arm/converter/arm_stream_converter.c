    ...
    { 
        ...
        */
        ...
        {   stream_al_services *stream_entry = (stream_al_services *)data;
            ...
            arm_stream_converter_instance *pinstance;
            fwd_ssrc_intermediate ssrc_intermediate;

            /* read memory banks */
            pinstance = (arm_stream_converter_instance *) (*memreq++);  /* 0 main instance */
        ...
        */         
        case STREAM_RUN:   
        {
            ...
            arm_stream_converter_process1 (&(pinstance->input), &(pinstance->output), 
                inBuf, pinstance->buff1);

            /* rate conversion 
                check FS_out / FS_in , compute nb_data_read, nb_data_write */
            arm_stream_converter_process2 (&(pinstance->ssrc),
            ...
            arm_stream_converter_process3 (&(pinstance->output),  
