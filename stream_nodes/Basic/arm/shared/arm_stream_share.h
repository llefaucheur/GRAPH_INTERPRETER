...
#define PACKSHARECONFIG_W0(OM,OE,NB,SLOPE) \
...
#define   SHARE_ARCID_IN_W2_MSB 20  
#define   SHARE_ARCID_IN_W2_LSB 16  /* 5 share arc index  */  
...
#define PACKSHARECHANNELS_W2(OM,OE,ARCID_IN,CHANID_IN) \
    ((OM)<<GAIN_MANTISSA_W2_LSB | (OE)<<GAIN_EXPONENT_W2_LSB | \
     (ARCID_IN)<<SHARE_ARCID_IN_W2_LSB | (CHANID_IN)<<SUBCHANID_IN_W2_LSB )
...
#define PACKSHARECHANNELS_W3(CHANID_OUT,MUTE) ((CHANID_OUT)<<SUBCHANID_OUT_W3_LSB| (MUTE)<<MUTED_CHANID_W3_LSB )
...
#define MAXSHAREINDEXES (1<<(NBINPUTARC_W0_MSB - NBINPUTARC_W0_LSB +1))
#define NB_W32_PARAMETERS (2 * MAXSHAREINDEXES + 1)
...
#define TAG_CMD_NB_INPUT 3
    ...
    /* 
        ...
        +----------+                                                    +----------------+
    */
    uint32_t share_current_mantissa [MAXSHAREINDEXES];

    /*
        multi-channel format 
    */
#define   ___SHARECHAN_FMT_MSB 31  
#define   ___SHARECHAN_FMT_LSB 30  
...
#define NBCHANM1_SHARE_FMT_MSB  4  
#define NBCHANM1_SHARE_FMT_LSB  0  /* 5 up to 32 channels */  
    uint32_t channel_fmt [MAXSHAREINDEXES];
