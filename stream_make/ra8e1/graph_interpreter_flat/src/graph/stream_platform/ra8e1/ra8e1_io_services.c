...
/* Local IO functions */
extern void data_sink      (uint32_t command, stream_xdmbuffer_t* data);        /*  IO_AL_idx = 0   SINK   */
extern void data_in_1      (uint32_t command, stream_xdmbuffer_t* data);        /*  IO_AL_idx = 1   io_ra8e1_data_in_1.txt   */
extern void analog_in_0    (uint32_t command, stream_xdmbuffer_t* data);        /*  IO_AL_idx = 2   io_ra8e1_analog_in_0.txt */
extern void motion_in_0    (uint32_t command, stream_xdmbuffer_t* data);        /*  IO_AL_idx = 3   io_ra8e1_motion_in_0.txt */
extern void audio_in_0     (uint32_t command, stream_xdmbuffer_t* data);        /*  IO_AL_idx = 4   io_ra8e1_audio_in_0.txt  */
extern void sensor_2d_in_0 (uint32_t command, stream_xdmbuffer_t* data);        /*  IO_AL_idx = 5   io_ra8e1_2d_in_0.txt  */
extern void line_out_0     (uint32_t command, stream_xdmbuffer_t* data);        /*  IO_AL_idx = 6   io_ra8e1_line_out_0.txt  */
extern void gpio_out_0     (uint32_t command, stream_xdmbuffer_t* data);        /*  IO_AL_idx = 7   io_ra8e1_gpio_out_0.txt  */
extern void gpio_out_1     (uint32_t command, stream_xdmbuffer_t* data);        /*  IO_AL_idx = 8   io_ra8e1_gpio_out_1.txt  */
extern void data_out_0     (uint32_t command, stream_xdmbuffer_t* data);        /*  IO_AL_idx = 9   io_ra8e1_data_out_0.txt  */
...
void gpio_out_1(uint32_t command, stream_xdmbuffer_t* data)
{
    ...
    {	extern void hal_set_led0_low(void);
    	...
    	stream_xdmbuffer_t* pt_pt = (stream_xdmbuffer_t*)data;

        /* "io_platform_stream_in_0," frame_size option in samples + FORMAT-0 in the example graph */
        arm_stream_io_ack(IO_PLATFORM_GPIO_OUT_1, (void *)(pt_pt->address), pt_pt->size);
