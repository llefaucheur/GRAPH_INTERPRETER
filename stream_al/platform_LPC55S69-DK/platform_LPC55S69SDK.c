...
#define MBANK_GRAPH_FLASH   U(0)    /* graph in flash */
#define MBANK_GRAPH_SRAM    U(1)    /* graph base address (shared) */
...
extern const uint32_t graph_input[];
    ...
    long_offset[MBANK_GRAPH_FLASH] = (intPtr_t)&(graph_input[1]); 
    long_offset[MBANK_GRAPH_SRAM]  = (intPtr_t)&(RAM1[0]); 
};
