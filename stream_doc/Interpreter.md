...
Sampling rate in unit "u"
Example `format_sampling_rate hertz 1e-3  ;   1mHz

### format_sampling_period "u t"

Sampling unit "u"
Example `format_sampling_period hour 24  ;   period of one day
...
Example `format_time_stamp 0 ; no time-stamp `
time-stamp format :
